...
class InsertionActivity : AppCompatActivity() {
    ...
    // Для предотвращения повторного внесения тех же данных пользователем
    ...
    private fun setBackgroundColor() {
        if (type == 1){
            ...
            btnSaveData.backgroundTintList = getColorStateList(R.color.blue_primary)
            window.statusBarColor = ContextCompat.getColor(this, R.color.blue_another)
        }else{
            ...
            btnSaveData.backgroundTintList = getColorStateList(R.color.violet_secondary)
